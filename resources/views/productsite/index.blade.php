                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="text-bg">
                                 <span class="heading">PackProSol is a tech-based solution developed by Holisol to provide one stop digital platform for all your packaging needs </span>
                                 <h5><b>Advantages of associating with us:</b></h5>
